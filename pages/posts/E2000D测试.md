...
2. 使用SFLY Flypro对<u>QSPI</u>(W25Q128JVxxQ)行<u>烧录</u>(flash烧写器夹子)`fip-all.bin`
...
7. 使用`x86_64-pc-windows-msvc-simple-http-server.exe`配合串口终端烧写`firmware`的`Image`以及设备树`e2000d-demo-board.dtb`
